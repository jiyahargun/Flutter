...
import 'package:sms/screens/facltylog.dart';

import '../database/mydb_helper.dart';
            ...
            child: ElevatedButton.icon(
              onPressed: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => FacultyLogs(facultyId: widget.facultyId),
                  ),
                );
              },
                              ...
                              children: [
                                ...
                                ElevatedButton(
                                  onPressed: () async {
                                    ...
                                    await db.addLog(
                                      widget.facultyId,
                                      'Updated marks for ${student['fname']} ${student['lname']}',
                                    );
